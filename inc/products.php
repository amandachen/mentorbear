...
function get_products_recent2($sku1, $sku2, $sku3, $sku4) {
    require(ROOT_PATH . "inc/database.php");
    ...
    try {
        $results= $db->prepare("
            ...
            LIMIT 4
            ");
        $results->bindParam(1,$sku1);
        $results->bindParam(2,$sku2);
        $results->bindParam(3,$sku3);
        $results->bindParam(4,$sku4);
        $results->execute();
...
function get_products_recent3($color) {
    require(ROOT_PATH . "inc/database.php");
...
function get_products_all() {
    ...
    */
    ...
    try {
        ...
        //throws exception when error in querying database
    } catch (Exception $e) {
        echo "Data error";
        exit;
    }
    $products = $results->fetchALL(PDO::FETCH_ASSOC);
//$results is a new kind of php object
...
function get_product_single($sku) {
    ...
    try {
        ...
        $results->execute();
            //results is a PDOStatement of object
    } catch (Exception $e) {
        echo "Data couldnt";
        exit;
    }
    ...
    while ($row = $results->fetch(PDO::FETCH_ASSOC)) {
        ...
        //blanks brackets add new element to sizes array
        //builds up array
    }
