...
(function ($, window, document, undefined) {
    ...
    var settings = {
        ...
        rtcStatusUpdate: {
            ...
            "entry": {
                statusHTML: 'Enter any room name into the field and<br>give that name to your mentor/mentee to enter...' + '<input id="videoChannelInput" class="video-channel-input" type="text" placeholder="enter channel name" />' + '<button id="videoChatStartButton" class="video-chat-start-button">Start Chat</button>',
