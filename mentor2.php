                                ...
                                <div class="col-md-9 flexy_content" style="padding-left: 0;padding-right: 0;">
                                    ...
                                    <div id="verticalTab">
                                        ...
                                        <ul class="resp-tabs-list">
                                            ...
                                            <a href="savementor2.php" id="downlowd"><i class="fa fa-save icon_print"></i> </a>
                                                        ...
                                                        <div class="bottom-p">
                                                            ...
                                                            <div class="panel-group" id="accordion">
                                                                ...
                                                                <div class="panel panel-default">
                                                                 ...
                                                                 <?php  if($_SESSION['prof3'][$z]['saturdays']==1) {
                                                                        echo "Saturdays <br>";

                                                                    }       
                                                                    if($_SESSION['prof3'][$z]['sundays']==1) {
                                                                        echo "Sundays <br>";
                                                                    }
                                                                    if($_SESSION['prof3'][$z]['weekdays']==1) {
                                                                        echo "Weekdays <br>";
                                                                    } 
