                                                    ...
                                                    <div class="col-md-6 profile-l">
                                                        ...
                                                        <div class="title_content">
                                                            <div class="text_content">
                                                                ...
                                                                <?php
                                                                echo htmlentities($_SESSION['user']['prof3'][0]['genderpref'], ENT_QUOTES, 'UTF-8'); ?></div>
                                                            <div class="clear"></div>
                                                        </div>
                                                        ...
                                                        <ul class="about">
                                                            ...
                                                            <li>
                                                                ...
                                                                <label>Name</label>
                                                                <span class="value"><?php echo htmlentities($_SESSION['user']['prof3'], ENT_QUOTES, 'UTF-8'); ?></span>
                                                                <div class="clear"></div>
                                                            </li>
                                                            ...
                                                            <li>
                                                                ...
                                                                <label>School</label>
                                                                <span class="value"><?php if($_SESSION['user']['prof3'][0]['genderpref']==1) {
                                                                        echo "High School";
                                                                    } else {
                                                                        echo "College";
                                                                    }
